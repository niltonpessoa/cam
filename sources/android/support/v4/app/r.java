...
class r extends s {
    ...
    class b implements Transition.TransitionListener {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            for (int i = 0; i < size; i++) {
                ((View) this.f136b.get(i)).setVisibility(0);
            }
        }
    ...
    class c implements Transition.TransitionListener {
        ...
        public void onTransitionStart(Transition transition) {
            ...
            if (obj != null) {
                r.this.q(obj, this.f138b, (ArrayList<View>) null);
            }
            Object obj2 = this.c;
            if (obj2 != null) {
                r.this.q(obj2, this.d, (ArrayList<View>) null);
            }
            Object obj3 = this.e;
            if (obj3 != null) {
                r.this.q(obj3, this.f, (ArrayList<View>) null);
            }
        }
    }
    ...
    private static boolean B(Transition transition) {
        return !s.l(transition.getTargetIds()) || !s.l(transition.getTargetNames()) || !s.l(transition.getTargetTypes());
    }
    ...
    public void b(Object obj, ArrayList<View> arrayList) {
        ...
        if (transition != null) {
            ...
            } else if (!B(transition) && s.l(transition.getTargets())) {
