...
public class X1WiFiPwdSetActivity extends Activity implements View.OnClickListener {
    ...
    private boolean b() {
        c0.a(0, "X1WiFiPwdSetActivity", "checkEnters()");
        String c2 = c(this.f1072b);
        if (!"".equals(c2)) {
    ...
    public void d() {
        c0.a(0, "X1WiFiPwdSetActivity", "dismissDeleteLoadingView()");
        f fVar = this.g;
    ...
    private void e() {
        /*
            ...
            r1 = 0
            java.lang.String r2 = "X1WiFiPwdSetActivity"
            java.lang.String r3 = "handleConfirmWiFiSet()"
            com.rp.rptool.util.c0.a(r1, r2, r3)
            boolean r1 = r7.b()
            if (r1 == 0) goto L_0x00aa
            android.widget.EditText r1 = r7.f1072b
        ...
        L_0x005a:
            ...
            byte[] r3 = com.rp.rptool.util.a0.a(r6, r3, r5)
            int r5 = com.rp.rptool.util.a0.b()
            r0.<init>(r2, r4, r3, r5)
            r7.f(r0)
        ...
        L_0x00aa:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xforce.v5.xdvpro.ui.X1WiFiPwdSetActivity.e():void");
    }

    private void f(b.b.e.a.a aVar) {
        c0.a(0, "X1WiFiPwdSetActivity", "sendIOCtrlMsgToDevs()");
        if (aVar == null) {
            c0.a(3, "X1WiFiPwdSetActivity", "sendIOCtrlMsgToDevs() error msg == null");
            return;
        }
        c0.a(0, "X1WiFiPwdSetActivity", "sendIOCtrlMsgToDevs() type = " + aVar.c());
    ...
    private void h() {
        c0.a(0, "X1WiFiPwdSetActivity", "showLoadingView()");
        if (this.g == null) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f1072b = (EditText) findViewById(R.id.wifi_dev);
        ...
        if (d0.t().p() != null) {
            this.f1072b.setText(e0.o().m(this));
        }
    }
