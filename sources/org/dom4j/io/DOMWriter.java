...
public class DOMWriter {
    ...
    public void appendDOMTree(Document document, Node node, List list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (obj instanceof Element) {
                ...
                appendDOMTree(document, node, text);
            }
        }
    }
    ...
    /* access modifiers changed from: protected */
    public Document createDomDocument(org.dom4j.Document document) {
    ...
    /* access modifiers changed from: protected */
    public Document createDomDocument(org.dom4j.Document document, DOMImplementation dOMImplementation) {
