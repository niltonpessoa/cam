...
public class DefaultElement extends AbstractElement {
    ...
    public List additionalNamespaces() {
        ...
        if (obj instanceof List) {
            ...
            return namespace2.equals(getNamespace()) ? createEmptyList() : createSingleResultList(namespace2);
        }
    }
    ...
    public List processingInstructions() {
        Object obj = this.content;
        if (!(obj instanceof List)) {
            return obj instanceof ProcessingInstruction ? createSingleResultList(obj) : createEmptyList();
        }
        List list = (List) obj;
        BackedList createResultList = createResultList();
        int size = list.size();
    ...
    public void setContent(List list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (obj instanceof Node) {
                ...
                node = getDocumentFactory().createText(obj.toString());
            }
            createContentList.add(node);
            childAdded(node);
        }
