...
public class NamespaceStack {
    ...
    public boolean contains(Namespace namespace) {
        ...
        Namespace defaultNamespace2 = (prefix == null || prefix.length() == 0) ? getDefaultNamespace() : getNamespaceForPrefix(prefix);
        if (defaultNamespace2 == null) {
            return false;
        }
        if (defaultNamespace2 == namespace) {
            return true;
        }
        return namespace.getURI().equals(defaultNamespace2.getURI());
    }
