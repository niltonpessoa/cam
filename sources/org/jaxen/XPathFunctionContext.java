...
public class XPathFunctionContext extends SimpleFunctionContext {
    ...
    public XPathFunctionContext() {
        ...
        registerFunction((String) null, "last", new LastFunction());
        ...
        registerFunction((String) null, "true", new TrueFunction());
        registerFunction((String) null, "translate", new TranslateFunction());
        registerFunction((String) null, "matrix-concat", new MatrixConcatFunction());
