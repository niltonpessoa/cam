...
public class LocationPathPattern extends Pattern {
    ...
    public void setNodeTest(NodeTest nodeTest2) {
    ...
    public Pattern simplify() {
        ...
        if (this.filters == null) {
            ...
            return (pattern3 == null && this.ancestorPattern == null) ? this.nodeTest : (pattern3 == null || this.ancestorPattern != null || !(this.nodeTest instanceof AnyNodeTest)) ? this : pattern3;
        }
    }
